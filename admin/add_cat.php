...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <h4 class="text-center">Add a New Branch</h4>
            <form action="" method="post">
                <div class="form-group">
                    <label for="name">Branch Name:</label>
                    <input type="text" class="form-control" name="cat_name" required>
                </div>
                <button type="submit" name="add_cat" class="btn btn-primary btn-block">Add Branch</button>
            </form>
        </div>
    </div>
</div>
<?php
    if ($branch_added) {
        echo "<script>alertMsg('Branch added successfully...');</script>";
    }
    if ($duplicate_branch) {
        echo "<script>alertMsg('Branch already exists!');</script>";
    }
?>
</body>
</html>
